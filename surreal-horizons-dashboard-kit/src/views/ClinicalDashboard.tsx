...
const MODULE_TABS: TabDef[] = [
  ...
  {
    id: 'mood_tracker',
    label: { es: 'Estado de Ánimo', en: 'Mood' },
    subtitle: { es: 'Estado de Ánimo', en: 'Mood state' },
    icon: Smile,
  ...
  },
  {
    ...
    label: { es: 'Consumo y Craving', en: 'Substance and Craving' },
    subtitle: { es: 'Consumo y craving', en: 'Substance and craving' },
    icon: Brain,
  ...
  {
    id: 'adhd_tracker',
    label: { es: 'Foco y TDAH', en: 'Focus and ADHD' },
