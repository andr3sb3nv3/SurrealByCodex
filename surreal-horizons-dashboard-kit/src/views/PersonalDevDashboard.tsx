...
const DEMO_TOOLS_ENABLED = false;
...
const PersonalDevDashboard: React.FC<DashboardProps> = ({
  ...
  const CLINICAL_METRIC_SEEDS: ClinicalMetricSeed[] = useMemo(() => ([
    ...
    { key: 'clin_bipolar', collectionName: 'deepClinicalLogsBipolar', sourceField: 'globalMood', toScale10: (v) => v + 5, labelEs: 'Estado de Ánimo', labelEn: 'Mood', color: '#8b5cf6', tailwindText: 'text-violet-500', tailwindBg: 'bg-violet-500/10', tailwindBorder: 'border-violet-500/50', gradId: 'cClinBipolar' },
    ...
    { key: 'clin_adhd', collectionName: 'deepClinicalLogsADHD', sourceField: 'focusLevel', toScale10: (v) => v, labelEs: 'Foco y TDAH', labelEn: 'Focus and ADHD', color: '#eab308', tailwindText: 'text-yellow-500', tailwindBg: 'bg-yellow-500/10', tailwindBorder: 'border-yellow-500/50', gradId: 'cClinADHD' },
    { key: 'clin_substance', collectionName: 'deepClinicalLogsSubstance', sourceField: 'cravingIntensity', toScale10: (v) => v, labelEs: 'Consumo y Craving', labelEn: 'Substance and Craving', color: '#f59e0b', tailwindText: 'text-amber-500', tailwindBg: 'bg-amber-500/10', tailwindBorder: 'border-amber-500/50', gradId: 'cClinSubstance' },
  ...
  return (
    <div className="min-h-screen bg-slate-50 dark:bg-slate-900 text-slate-900 dark:text-slate-100 font-sans pb-10 transition-colors duration-300">
      ...
      {DEMO_TOOLS_ENABLED && showDemoModal && (
